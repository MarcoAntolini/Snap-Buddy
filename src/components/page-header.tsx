...
function PageHeaderSection({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
	return <Balance className={cn("mt-3 flex max-w-[750px] flex-col items-center gap-2", className)} {...props} />;
}
...
export { PageActions, PageHeader, PageHeaderDescription, PageHeaderHeading, PageHeaderSection };
